...
function DateVenuePage() {
  ...
  return (
    <div className="px-6 md:px-16 py-8 md:py-12">
      ...
      <h1 className="font-heading text-2xl md:text-3xl text-gray-800 mb-6 md:mb-10">DATE &amp; VENUE</h1>
      ...
      {/* Status bar */}
      <div className="border-t border-gold/30 pt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
